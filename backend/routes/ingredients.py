...
from backend.models.ingredient import IngredientInfo, PreferencesRequest, PreferencesResponse
...
@router.get("/ingredients/{name}", response_model=IngredientInfo)
async def get_ingredient(name: str) -> IngredientInfo:
